  ...
  function injectSmartButton() {
    ...
    <div class="circle-container">
      <div class="circle">
        ...
        <div class="menu-item" data-link="#" style="--index: 6;"><img src="asset/img/icon/other.png" alt="other"></div>
        ...
        <div class="menu-item" data-link="404.html" style="--index: 12;"><img src="asset/img/icon/rx.png" alt="Logo"></div>
      </div>
    </div>
    `;
