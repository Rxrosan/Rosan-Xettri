document.addEventListener('DOMContentLoaded', function() {
    ...
    // Updated CSS for balanced font size and matching theme color
    const style = document.createElement('style');
    style.textContent = `
         #auto-writer {
            min-height: 1.2em;
            font-family: Arial, sans-serif;
            font-size: clamp(12px, 2.5vw, 15px); /* सन्तुलित र उत्तरदायी (Responsive) साइज */
            font-weight: bold;
            color: #1a4480; /* वेबसाइटको header सँग मिल्ने रङ */
            line-height: 1.4;
            text-align: center;
            width: 100%;
        }
