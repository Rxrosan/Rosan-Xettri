    ...
    function loadHistory() {
      ...
      history.forEach((item, index) => {
        ...
        const isEncrypted = item.type === 'encrypt';
        const hasPassword = item.password ? `<strong>Password:</strong> ${item.password}` : '';
        ...
        html += `
          <div class="history-item">
            ...
            <div class="history-actions">
              ${isEncrypted && item.qrImage ? `<button class="btn btn-text" onclick="downloadHistoryQR('${item.qrImage}', 'secure-qr-code-${index}.png')"><i class="fas fa-download"></i> Download QR</button>` : ''}
