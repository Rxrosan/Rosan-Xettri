// RX-WEB-P&P.js - Privacy & Policy Tab Functionality

document.addEventListener('DOMContentLoaded', function() {
    // ===== PRIVACY TABS SWITCHING =====
    const tabBtns = document.querySelectorAll('.pp-tabs .tab-btn');
    const tabContents = document.querySelectorAll('.pp-tabs .tab-content');
    ...
    if (tabBtns.length > 0) {
        ...
        if (!document.querySelector('.pp-tabs .tab-btn.active')) {
    ...
    console.log('RX Privacy & Policy module loaded - matching Service page style');
});