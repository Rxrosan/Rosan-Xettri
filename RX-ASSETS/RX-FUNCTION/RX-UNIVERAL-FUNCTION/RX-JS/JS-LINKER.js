...
(function() {
    ...
    const contentMapping = {
        ...
        'file1': {
            path: 'RX-ASSETS/RX-EXAM-FILE/KR-EXAM-QUESTION-FILE/KR-EXAM-QM-1/QUESTION/KR-EXAM-QM-1.js',
            type: 'js'
        },
        'file4': {
    ...
    async function main() {
        ...
        if (!contentConfig) {
            const errorMessage = `No content is mapped for ID: "${selectedContentId}". Check 'contentMapping' in JS-LINKER.js.`;
            console.error(errorMessage);
