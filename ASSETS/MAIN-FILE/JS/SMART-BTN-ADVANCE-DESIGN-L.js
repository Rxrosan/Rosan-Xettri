  ...
  function injectSmartButton() {
    ...
    <div class="RX-SMART-BUTTON-container">
      <div class="RX-SMART-BUTTON-circle">
        ...
        <div class="RX-SMART-BUTTON-menu-item" data-link="RX-Weather.html" style="--index: 1;"><img src="ASSETS/MAIN-FILE/IMG/FUNCTION-ICON/weather.png" alt="weather"></div>
        <div class="RX-SMART-BUTTON-menu-item" data-link="RX-Calendar.html" style="--index: 2;"><img src="ASSETS/MAIN-FILE/IMG/FUNCTION-ICON/calender.png" alt="Calander"></div>
