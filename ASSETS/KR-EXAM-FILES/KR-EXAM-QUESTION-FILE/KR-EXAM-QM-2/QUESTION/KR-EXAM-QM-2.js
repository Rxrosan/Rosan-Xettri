window.questions = [
  {
     ...
     options: { a: "이불", b: "방", c: "휴식", d: "침대" },
     answer: "d",
     explanation: "Review not Aviable.",
     image: "ASSETS/KR-EXAM-FILES/KR-EXAM-QUESTION-FILE/KR-EXAM-ALL-IMG/IMG-19.png"
   },
   {
     question: "",
     options: { a: "선생", b: "엄마", c: "언니 / 누나", d: "학교" },
     answer: "a",
     explanation: "Review not Aviable.",
     image: "ASSETS/KR-EXAM-FILES/KR-EXAM-QUESTION-FILE/KR-EXAM-ALL-IMG/IMG-21.png"
   },
   {
     question: "[3-4] 다음 단어와 비슷한 말을 무엇입니까?<br> <br> 올해",
     options: { a: "다음해", b: "금주", c: "금년", d: "모처럼" },
     answer: "c",
     explanation: "Review not Aviable."
   },
   {
     question: "다음 단어와 관계있는 것은 무엇입니까?<br> <br>미역국 , 케이크",
     options: { a: "추석", b: "생신", c: "설날", d: "생산" },
     answer: "b",
     explanation: "Review not Aviable."
   },
   {
     question: "[5-6]이 사람의 직업은 무엇은 입니까?",
     options: { a: "목수 입니다.", b: "근로자 입니다.", c: "점원 입니다.", d: "기술자 입니다." },
     answer: "a",
     explanation: "Review not Aviable.",
     image: "ASSETS/KR-EXAM-FILES/KR-EXAM-QUESTION-FILE/KR-EXAM-ALL-IMG/IMG-24.png"
   },
   {
     question: "다음 밑줄 친 부분이 맞는 문장을 고르십시오.",
     options: { a: "불고기를 <u>만들아서</u> 먹었어요.", b: "고항에 가서 <u>부모님을</u> 만났어요.", c: "편지를 쓰서 친구에게 <u>줬어요</U>.", d: "아침에 <u>일어났어서</u> 운동했어요." },
     answer: "b",
     explanation: "Review not Aviable."
   },
   {
   ...
   },
 {
   ...
   },
   {
     ...
     answer: "d",
     explanation: "Review not Aviable.",
     image: "ASSETS/KR-EXAM-FILES/KR-EXAM-QUESTION-FILE/KR-EXAM-ALL-IMG/IMG-20.png"
   },
   {
     ...
     answer: "a",
     explanation: "Review not Aviable.",
     image: "ASSETS/KR-EXAM-FILES/KR-EXAM-QUESTION-FILE/KR-EXAM-ALL-IMG/IMG-22.png"
   },
   {
     question: "이것은 무엇입니까?",
